...
- 快速保存：待复盘 / 诈唬 / 抓诈 / Hero Fold / 价值 / 冤家 / 自定义、Hero 位置、有效后手、Hero 手牌点选
- 补行动路线：翻前默认自定义，按行动顺序逐条记录；Flop / Turn / River 点选公共牌
- 路线页固定信息条：记录过程中常驻展示 Hero 手牌、公共牌、当前街与底池，减少回看和记错
- 待复盘列表：待补全优先、最新在前、继续补路线、查看回放
- 手牌记录删除：主页手牌记录支持左滑删除，并二次确认
- 回放与复盘三问：保存复盘后返回首页，避免保存无反馈
- 本场 Session 管理：可结束本场，结束后回到历史场次；历史场次可重新进入查看、补复盘，也可继续记录
- Markdown 复制与系统分享
